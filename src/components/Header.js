  ...
  <div className="container">
    ...
    <li className="nav-item d-none d-sm-inline-block">
      <a href="#" className="nav-link">Datasets</a>
        ...
        <li className="nav-item dropdown">
          <a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" className="nav-link dropdown-toggle">SQL</a>
          <ul aria-labelledby="dropdownSubMenu1" className="dropdown-menu border-0 shadow">
            <li><a href="#" className="dropdown-item">SQL Lab </a></li>
            <li><a href="#" className="dropdown-item">Saved Queries</a></li>
            <li><a href="#" className="dropdown-item">Query History</a></li>
          </ul>
        </li>
      </ul>
    </div>
...
<li className="dropdown-submenu dropdown-hover">
  ...
  <ul aria-labelledby="dropdownSubMenu2" className="dropdown-menu border-0 shadow">
    ...
    <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
    <li><a href="#" class="dropdown-item">Data access role </a></li>
    <li><a href="#" class="dropdown-item">Row lavel Security</a></li>
    <li><a href="#" class="dropdown-item">Database connection</a></li>
    </ul>
    </li>
